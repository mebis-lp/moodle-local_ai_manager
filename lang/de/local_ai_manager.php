...
$string['mp_configuration'] = 'Konfiguration';
$string['mp_statistics'] = 'Nutzertatistik';
$string['mp_usagestatistics'] = 'Nutzungsstatistik';
$string['mp_heading_api_keys'] = 'API-Schlüssel';
$string['mp_heading_tool_purpose_matching'] = 'Zuordnung von Sprachmodellen und Zweck';
$string['mp_used_tokens'] = 'Verbrauchte Token';
$string['mp_estimated_costs'] = 'Geschätzte Kosten';
