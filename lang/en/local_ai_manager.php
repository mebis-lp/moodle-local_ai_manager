...
$string['confirmaitoolsusage_description'] = 'You are about to use an AI tool. Whenever you are about to use such an tool from inside the mebis Lernplattform you will be informed by an info box which contains specific information about the usage of your data.';
...
$string['error_usernotconfirmed'] = 'For being able to use the AI functions, please accept the terms of use:';
...
$string['privacy_terms_text1'] = 'The general terms of use of the mebis learning platform apply, especially AI tools, see ... TODO ...';
...
$string['table_heading_endpoint'] = 'ENDPOINT';
$string['table_heading_infolink'] = 'INFO LINK';
$string['table_heading_instance_name'] = 'INSTANCE NAME';
...
$string['userstatusupdated'] = 'The user status has been updated';
$string['within'] = 'in';
