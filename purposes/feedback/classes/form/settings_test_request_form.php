...
/**
 * aipurpose_feedback Form class to test request.
 *
...
namespace aipurpose_feedback\form;
...
class settings_test_request_form extends \moodleform {
    ...
    public function definition() {
        ...
        $this->add_action_buttons(false, get_string('api_test_connection', 'aipurpose_feedback'));
    }
}
