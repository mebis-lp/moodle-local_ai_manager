...
$string['adddescription'] = 'Mistral AI is a french AI service.';
...
$string['pluginname'] = 'Mistral AI';
$string['privacy:metadata'] = 'The local ai_manager tool subplugin "Mistral AI" does not store any personal data.';
