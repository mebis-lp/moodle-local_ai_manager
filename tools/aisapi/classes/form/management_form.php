...
class management_form extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'baseurl', get_string('baseurl', 'aitool_aisapi'), ['size' => '60']);
        ...
        $mform->addElement('passwordunmask', 'apikey', get_string('apikey', 'aitool_aisapi'), ['size' => '60']);
        ...
        $this->add_action_buttons(true, get_string('retrieveinformation', 'aitool_aisapi'));
    }
