...
/**
 * Tabs for admin setting pages.
 * Idea giver: theme/boost/classes/admin_settingspage_tabs.php
 *
 * @package   local_ai_manager
 * @copyright  ISB Bayern, 2024
 * @author     Dr. Peter Mayer
...
class admin_settingspage_tabs extends \admin_settingpage {
    ...
    public function output_html() {
        ...
        foreach ($this->get_tabs() as $tab) {
            ...
            $descr = trim($descr);
            if (!empty($visiblename) && !empty($descr)) {
                $tab->visiblename = $visiblename;
                $tab->description = $descr;
            }
        ...
        return $OUTPUT->render_from_template('local_ai_manager/admin_setting_tabs', $context);
    }
