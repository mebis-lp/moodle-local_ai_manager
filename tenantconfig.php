...
$modelconfigform = new \local_ai_manager\form\modelconfigform(null, ['tenant' => $tenant, 'returnurl' => $PAGE->url]);

// Standard form processing if statement.
if ($modelconfigform->is_cancelled()) {
    redirect($returnurl);
} else if ($data = $modelconfigform->get_data()) {
    print_r($data);
